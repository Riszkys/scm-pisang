					...
					?>
							...
							<div class="bg-light px-4 py-3">
								<div class="row align-items-center text-center">
									<div class="col-md-6 mb-3 mb-md-0 text-md-left"><a class="btn btn-link p-0 text-dark btn-sm" href="index.php">Nomor Rekening : 35152717 (A/N tes123)</a></div>
									...
									<br>
									<div class="col-md-6  text-md-left"><a class="btn btn-link p-0 text-dark btn-sm" href="index.php"><i class="fas fa-long-arrow-alt-left mr-2"> </i>Lanjut Belanja</a></div>
